...
namespace pandemic{
    ...
    public:
        //constructor
        Characters(Board board, City city);
         ...
         */
        virtual void take_card(City city);
